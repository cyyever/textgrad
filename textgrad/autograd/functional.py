...
def llm_call(
    ...
    """
    return LLMCall(engine=engine, system_prompt=system_prompt)(
        input_variable, response_role_description
    )


def formatted_llm_call(
    inputs: List[Variable],
    response_role_description: str,
    engine: EngineLM,
    format_string: str,
    fields: dict[str, str],
    system_prompt: Variable | None = None,
